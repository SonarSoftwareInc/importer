...
class AccountIpAssignmentImporter extends AccessesSonar
{
    ...
    public function import($pathToImportFile)
    {
        if (($handle = fopen($pathToImportFile,"r")) !== FALSE)
        {
            ...
            $failureLogName = tempnam(getcwd() . "/log_output", "account_ip_mac_assignment_import_failures");
            $failureLog = fopen($failureLogName,"w");

            $successLogName = tempnam(getcwd() . "/log_output","account_ip_mac_assignment_import_successes");
